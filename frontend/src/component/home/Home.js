...
const ExampleCarouselImage2 = ({ src, alt }) => {
  return <img className="d-block w-100" src={src} alt={alt} />;
};
...
return (
  ...
  <AUNavbar />
    <Carousel activeIndex={index} onSelect={handleSelect}>
      <Carousel.Item>
        <ExampleCarouselImage2 src="https://images.unsplash.com/photo-1464454709131-ffd692591ee5?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8Zm9vZCUyMHN1cHBsaWVycyUyMGluJTIwZXZlbnRzfGVufDB8fDB8fHww" alt="First slide" />
        <Carousel.Caption>
          <h3>First slide label</h3>
          <p>Nulla vitae elit libero, a pharetra augue mollis interdum.</p>
        </Carousel.Caption>
      ...
      <Carousel.Item>
        <ExampleCarouselImage2 src="https://images.unsplash.com/photo-1511688878353-3a2f5be94cd7?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8N3x8Zm9vZCUyMHN1cHBsaWVycyUyMGluJTIwZXZlbnRzfGVufDB8fDB8fHww" alt="Second slide" />
        <Carousel.Caption>
          <h3>Second slide label</h3>
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
        </Carousel.Caption>
      ...
      <Carousel.Item>
        <ExampleCarouselImage2 src="https://media.istockphoto.com/id/1416840549/photo/radha-krishna-beautiful-statue-image-hd.webp?b=1&s=170667a&w=0&k=20&c=LV5GO4ox3nNgBe1GG2hS4kKgSB9mLQ7NIxeCRxm372Q=" alt="Third slide" />
        <Carousel.Caption>
          <h3>Third slide label</h3>
          <p>Praesent commodo cursus magna, vel scelerisque nisl consectetur.</p>
        </Carousel.Caption>
